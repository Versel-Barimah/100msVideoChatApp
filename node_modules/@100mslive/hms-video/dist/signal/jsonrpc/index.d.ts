...
import { Track, AcceptRoleChangeParams, RequestForRoleChangeParams, TrackUpdateRequestParams, RemovePeerRequest, MultiTrackUpdateRequestParams, StartRTMPOrRecordingRequestParams, UpdatePeerRequestParams, HLSRequestParams } from '../interfaces';
...
export default class JsonRpcSignal implements ISignal {
    ...
    close(): Promise<void>;
    join(name: string, data: string, offer: RTCSessionDescriptionInit, disableVidAutoSub: boolean, serverSubDegrade: boolean): Promise<RTCSessionDescriptionInit>;
